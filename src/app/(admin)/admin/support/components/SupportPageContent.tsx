...
const SupportTicketManagement = () => {
    ...
    try {
      ...
      if (ticketMessage) {
        const categoryLabel = category
          ? TICKET_CATEGORY_LABELS[
              category as keyof typeof TICKET_CATEGORY_LABELS
            ]
          : "";
  ...
  return (
    <div className="space-y-6">
      <SupportStatsCards statsLoading={statsLoading} stats={stats} />

      <SupportSearch value={searchTerm} onChange={handleSearch} />
                      ...
                      {isLoading || isFetching ? (
                        ...
                        tickets.map((ticket) => (
                          ...
                          >
                            ...
                            <td className="py-3 px-4">
                              <Badge
                                className={`${TICKET_STATUS_COLORS[ticket.status]} border-0`}
                              >
                            ...
                            <td className="py-3 px-4">
                              <DropdownMenu>
                                <DropdownMenuTrigger asChild>
                                  ...
                                  >
                                    <Badge
                                      className={`${TICKET_PRIORITY_COLORS[ticket.priority]} border-0 cursor-pointer`}
                                    >
                                ...
                                <DropdownMenuContent align="start">
                                  {Object.values(TICKET_PRIORITY).map(
                                    (priority) => (
                                      <DropdownMenuItem
                                        key={priority}
                                        onClick={() =>
                                      ...
                                      >
                                        <Badge
                                          className={`${TICKET_PRIORITY_COLORS[priority]} border-0 mr-2`}
                                        >
      ...
      <Dialog
        open={!!selectedTicket && !showStatusModal && !showNotesModal}
      ...
      >
        <DialogContent className="sm:max-w-2xl">
            ...
            <div className="space-y-4 py-4">
              <div className="grid grid-cols-2 md:grid-cols-3 gap-4 text-sm">
                ...
                <div>
                  ...
                  <Badge
                    className={TICKET_PRIORITY_COLORS[selectedTicket.priority]}
                  >
          ...
          <DialogFooter className="gap-2 flex-wrap">
            ...
            <Button
              onClick={() => selectedTicket && openStatusModal(selectedTicket)}
            >
              Update Status
            </Button>
          </DialogFooter>
        ...
        <DialogContent className="sm:max-w-md">
          ...
          <div className="space-y-4 py-4">
            <div className="space-y-2">
              ...
              <Select
                value={newStatus}
                onValueChange={(value) => setNewStatus(value as TICKET_STATUS)}
              >
