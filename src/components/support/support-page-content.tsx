...
export default function SupportPageContent() {
  ...
  const { data: faqs, isLoading: faqsLoading } = useActiveFAQs();
        ...
        {faqsLoading ? (
          <>
            {[1, 2, 3].map((i) => (
              <div
                key={i}
                className="bg-white rounded-lg shadow-sm border-2 border-[#85C2DE] px-5 py-4 sm:px-6 sm:py-5"
              >
              ...
              >
                <CardContent className="p-4">
                  <div className="flex justify-between items-start gap-4">
                    ...
                    <Badge
                      className={`${TICKET_STATUS_COLORS[ticket.status]} flex items-center gap-1 shrink-0`}
                    >
          ...
          <div className="space-y-4 py-4">
            ...
            <div className="space-y-2">
              ...
              <Select
                ...
                onValueChange={(value) =>
                  setTicketCategory(value as TICKET_CATEGORY)
                }
              >
